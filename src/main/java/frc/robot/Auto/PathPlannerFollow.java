...
public class PathPlannerFollow {
    ...
    private PathPlannerFollow(DriveSubsystem drive, String autoName, double maxVelocity, double acceleration, HashMap<String, Command> eventMap) {
        this.drive = drive;
    ...
    private PathPlannerFollow(DriveSubsystem drive, String patautoNamehName) {
        this.drive = drive;
        this.autoName = patautoNamehName;
    }

    public static PathPlannerFollow create(DriveSubsystem drive, String autoName) {
